...
| **64×64 intl+fixAmp M-sweep** (how test_r depends on M; population sweet spot M=200–300; minority cells degrade at large M — accepted as known limit) | **`experiments/2026-04-13_M_sweep_64x64/README.md`** (984-fit sweep, 41 cells × 8 M × 3 seeds; investigation story + closure at `investigations/M_degradation/FINDINGS.md`) |
